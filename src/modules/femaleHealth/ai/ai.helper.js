...
//     const week = userData.currentWeek || 1;
//     if (week <= 12) {
//       return "Focus on prenatal vitamins, hydration, and rest. Avoid stress — your baby’s organs are forming.";
//     } else if (week <= 26) {
//       return "Eat iron-rich foods, stay active, and begin light exercises. Keep track of baby movements.";
//     } else if (week <= 40) {
//       return "Prepare for delivery: pack a hospital bag, attend antenatal sessions, and rest frequently.";
//     }
//     return "Maintain regular medical checkups and follow your doctor’s guidance.";
//   }
...
//     if (notes.toLowerCase().includes("pain")) {
//       return "Apply a warm compress, stay hydrated, and try light stretching to relieve menstrual cramps.";
//     }
//     return "Track your cycle regularly and eat iron-rich foods to replace blood loss during menstruation.";
//   }
